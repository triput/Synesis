    ...
    if (!isClosed) {
      emit(
        state.copyWith(
          ...
          headersLoadingMessageId: result.headersLoadingMessageId,
          clearHeadersLoading: result.clearHeadersLoading,
          headersErrorMessageId: result.headersErrorMessageId,
          clearHeadersErrorMessageId: result.clearHeadersErrorMessageId,

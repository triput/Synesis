...
| **Wave 6b** | CalDAV/CardDAV **create-only write** for copy targets (Runbox) | Tesla + Jules | **In progress** — E7 **GO** (**668 tests**); E8 Runbox dogfood open — [V2_WAVE_6B_CHECKLIST.md](V2_WAVE_6B_CHECKLIST.md) · [V2_WAVE_6B_QA.md](V2_WAVE_6B_QA.md) |
...
| **Wave 6b** | CalDAV/CardDAV write (copy targets) | **In progress** — E7 **GO** (**668 tests**); E8 open — [V2_WAVE_6B_CHECKLIST.md](V2_WAVE_6B_CHECKLIST.md) · [V2_WAVE_6B_QA.md](V2_WAVE_6B_QA.md) |

...
| Last updated | 2026-07-27 (V2 Wave 4 complete — Wave 5 next) |
...
Horizon backlog with promotion framework (V1.1 → V2 → enterprise). **V1.5 complete 2026-07-27** — see [V1_5_PLAN.md](V1_5_PLAN.md) §5. **V2 Wave 0 complete**; **Wave H complete**; **Wave 1 / V2.0a P0 complete** (2026-07-27, `00ebdef`); **Wave 2 complete** (2026-07-27, `b526e70`, 530 tests); **Wave 3 complete** (2026-07-27, 551 tests); **Wave 4 / V2.0b complete** (2026-07-27, SHA `pending`, 556 tests) — [V2_WAVE4_CHECKLIST.md](V2_WAVE4_CHECKLIST.md), [V2_WAVE4_QA.md](V2_WAVE4_QA.md) (**GO**). **Wave 5 (picker + Calendar UI) is next.**
...
| 2 | **V2 headline = PIM** — Outlook-style modules; CardDAV/CalDAV day-one (Runbox); Graph-first order — [V2_PLAN.md](V2_PLAN.md). **Wave 0 complete**; **Wave H complete**; **Wave 1 complete**; **Wave 2 complete**; **Wave 3 complete**; **Wave 4 complete** (2026-07-27, SHA `pending`, 556 tests); **Wave 5 next** |
...
**Status:** **Wave 4 complete** (2026-07-27, SHA `pending`, 556 tests) — [V2_WAVE4_CHECKLIST.md](V2_WAVE4_CHECKLIST.md). Renee QA: [V2_WAVE4_QA.md](V2_WAVE4_QA.md) (**GO**). **Wave 5 is next** (compose picker + Calendar UI). Wave 3 complete (2026-07-27, `7cbfdaa`, 551 tests); Renee QA **GO** — [V2_WAVE3_QA.md](V2_WAVE3_QA.md). Wave 2 complete (2026-07-27, `b526e70`); [V2_WAVE2_QA.md](V2_WAVE2_QA.md). Wave 1 complete (2026-07-27, `00ebdef`); [V2_0A_P0_QA.md](V2_0A_P0_QA.md). Full plan: [V2_PLAN.md](V2_PLAN.md).
...
| **Wave 4** | P3–P4 — CardDAV/CalDAV (Runbox) | **Complete** (2026-07-27, SHA `pending`, 556 tests) | V2.0b |
| **Wave 5** | P5–P6 — compose picker + Calendar UI (multi-select overlay / side-by-side) | **Next** | V2.0c |
...
| **V2.0 (TD-A)** | **Wave 0:** account identity — **complete**. **Wave H:** dependency hygiene — **complete**. **Wave 1:** P0 schema — **complete** (2026-07-27). **Wave 2 complete:** Graph PIM; **Wave 3 complete:** meeting-mail bridge (551 tests); **Wave 4 complete:** CardDAV/CalDAV (556 tests); **Wave 5 next:** picker + Calendar UI | Major version — [V2_PLAN.md](V2_PLAN.md) |
...
**Locked:** V1.5 adjacency · V2.0 = PIM (+ CardDAV/CalDAV) · **Wave 0 complete · Wave H complete · Wave 1 complete · Wave 2 complete · Wave 3 complete · Wave 4 complete (556 tests) · Wave 5 next** · Watch = V2.1 P3 · Enterprise + AI = Maybe/Someday · D6-3 must-ship.

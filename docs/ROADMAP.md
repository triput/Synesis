...
Horizon backlog with promotion framework (V1.1 → V2 → enterprise). **V1.5 complete 2026-07-27** — see [V1_5_PLAN.md](V1_5_PLAN.md) §5. **V2 Wave 0 complete**; **Wave H complete**; **Wave 1 / V2.0a P0 complete** (2026-07-27, `00ebdef`); **Wave 2 complete** (2026-07-27, `b526e70`, 530 tests); **Wave 3 complete** (2026-07-27, 551 tests); **Wave 4 / V2.0b complete** (2026-07-27, `f2bd29b`, 556 tests) — [V2_WAVE4_CHECKLIST.md](V2_WAVE4_CHECKLIST.md), [V2_WAVE4_QA.md](V2_WAVE4_QA.md) (**GO**). **Wave 5 (picker + Calendar UI) is next.**
...
| 2 | **V2 headline = PIM** — Outlook-style modules; CardDAV/CalDAV day-one (Runbox); Graph-first order — [V2_PLAN.md](V2_PLAN.md). **Wave 0 complete**; **Wave H complete**; **Wave 1 complete**; **Wave 2 complete**; **Wave 3 complete**; **Wave 4 complete** (2026-07-27, `f2bd29b`, 556 tests); **Wave 5 next** |

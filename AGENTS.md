...
**V2 status (2026-07-27):** Waves 0–G complete (account identity, dependency hygiene, PIM P0–P6 UI, Google People + Calendar API). **Wave 6** (cross-account DnD copy) is **next on critical path** — see [V2 Plan](docs/V2_PLAN.md).

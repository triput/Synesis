...
**V2 status (2026-07-27):** Waves 0–5 complete (account identity, dependency hygiene, PIM P0–P6 UI). **Wave G** (Google People + Calendar API) is **next on critical path** — see [V2 Plan](docs/V2_PLAN.md).

...
**V2 status (2026-08-25):** Waves 0–G, **6P**, **6**, **6b**, and **Operation Flat Zero** complete (**729+ tests**). **Wave 6c** (calendar series / RRULE) **parked**. V2.0 feature spine done; exit = PIM docs/E2E + optional Wave 7. **Next operator track = Wave WEB** (personal, not release-blocking). See [V2 Plan](docs/V2_PLAN.md) · [ROADMAP](docs/ROADMAP.md).

...
**V2 status (2026-08-12):** Waves 0–G, **Wave 6P**, **Wave 6**, and **Wave 6b** complete (**668 tests**). **Wave 6c** (calendar series / RRULE) **parked** — hard-stop after 6b; do not auto-start. Next priority = **Android Pri-2 (DEF-085, DEF-082)** / Wave 7 candidates. Corporate Graph research is post–Wave 6. See [V2 Plan](docs/V2_PLAN.md) · [Wave 6b checklist](docs/V2_WAVE_6B_CHECKLIST.md) · [Wave 6 checklist](docs/V2_WAVE_6_CHECKLIST.md) · [Wave 6 QA](docs/V2_WAVE_6_QA.md) · [Wave 6P checklist](docs/V2_WAVE_6P_CHECKLIST.md).
